...
*(Illustrative — `f2f` has been checked against its captured fixture only, not live-smoke-tested the way `wt` has; see design.md Open Questions.)*
...
*(Illustrative — `hfx` has been checked against its captured fixture only, not live-smoke-tested the way `wt` has; see design.md Open Questions.)*
